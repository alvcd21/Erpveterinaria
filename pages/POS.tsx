...
const POS: React.FC = () => {
  ...
  const generateInvoicePDF = (saleId: string) => {
      try {
          ...
          // 2. Logo (Imagen Base64 si existe)
          if (LOGO_BASE64) {
              doc.addImage(LOGO_BASE64, 'PNG', 14, 10, 20, 20);
          } else {
              // Si no has pegado el base64, dibujará un logo temporal de puntos para no dejar vacío
          ...
          // 3. Info Empresa desde tabla Config
          ...
          doc.setFontSize(8);
          doc.text(direccionEmpresa, 38, 24);
          doc.text(`Tel: ${telefonoEmpresa}`, 38, 29);
          ...
          // 6. Datos Fiscales (Desde tabla Config)
          const rightColX = 120;
          ...
          // 10. Pie Legal (Desde tabla Config)
