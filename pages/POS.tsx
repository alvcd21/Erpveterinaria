  ...
  const loadSaleToEdit = async (saleId: string) => {
    try {
      ...
      if (header) {
        ...
        // Mapeo detallado para asegurar que las descripciones y IDs aparezcan en el carrito
        setCart(details.map(d => ({
          ...d,
          cantidad: Number(d.cantidad),
          precioVenta: Number(d.precioVenta),
          // Asegurar que idInventario esté presente si es accesorio para stock lookups
